      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 mt-2 w-full max-h-60 overflow-y-auto bg-slate-900 border border-slate-700 rounded-xl shadow-xl z-50 py-1 scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-transparent"
          >
            {options.map((option) => {
